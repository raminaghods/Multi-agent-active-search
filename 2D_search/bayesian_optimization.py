...
class Bayesian_optimizer(object):
	...
	def __init__(self, trialnum, worker_manager, func_caller, options=None):
		""" Constructor """
...
#		self.B = None  
	...
	def _optimise_wrap_up(self):
		...
		with open('X_Y_trialnum_%d.pkl'%(self.trialnum),'wb') as f:
